...
const steps = [
  ...
  },
  {
    ...
    description:
      "רשמו בין השקופיות את הכותרת של היחידה וצבעו את הרקע שלה בצהוב. הכניסו בין השקופיות שאלות סטטיות לפי התבנית שבאתר.",
  ...
  },
  {
    ...
    description:
      "כל מספר שקופיות יאוגדו לעמוד אחד עם גלילה, ושקופית השער הצהובה תהפוך לכותרת בלשונית הניווט. גם הכותרות שבמצגת יהפכו אוטומטית לפרקי משנה תחת הפרק הראשי.",
